<template>
    <header class="text-text shadow-sm sticky top-0 z-50 bg-bg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <button @click="goBack"
                        class="flex items-center justify-center p-2 rounded-full bg-text/20 hover:bg-text/30 transition-all duration-200 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-text/50"
                        aria-label="返回列表">
                ...
                <div class="flex flex-col items-end gap-2"
                    :class="{ 'text-up': stock.change > 0, 'text-down': stock.change < 0 }">
