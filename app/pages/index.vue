    ...
    <div class="min-h-screen bg-linear-to-br from-bg-surface to-bg flex flex-col items-center">
        ...
        <main class="flex-1 w-full px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-bg rounded-2xl shadow-md shadow-shadow p-4 sm:p-6 mb-6 sm:mb-8 transition-all duration-300">
                <div class="flex flex-row gap-3 sm:gap-4 items-center justify-between min-w-0">
                    ...
                    <div class="relative flex-1 min-w-0">
                        ...
                        />
                        <svg
                            class="absolute left-2.5 top-1/2 transform -translate-y-1/2 text-text-muted"
                            viewBox="0 0 24 24"
                            width="18"
                            sm:width="20"
                            height="18"
            ...
            <div class="bg-bg rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl min-h-[300px]">
                ...
                <!-- Empty State -->
                <div
                    v-else-if="!stocks || stocks.length === 0"
                ...
                >
                    ...
                    <p class="text-text font-medium text-base sm:text-lg">
                ...
                <div v-else class="sm:mx-0 overflow-x-auto">
                    <PagesIndexStockTable :data="stocks" />
                </div>
            </div>
        </main>
    </div>
...
import PagesIndexStockTable from "@/components/pages/index/stock-table.vue";
