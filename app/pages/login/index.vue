                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <input id="code" v-model="formData.code" type="text" inputmode="numeric" maxlength="6"
                                placeholder="请输入6位验证码" :disabled="isLoading" autocomplete="off"
                            ...
                            <button type="button" @click="sendVerificationCode" :disabled="!canSendCode || isLoading"
...
const loginSchema = z.object({
    ...
    code: z.string().trim().regex(/^\d{6}$/, '验证码必须是6位数字')
})
